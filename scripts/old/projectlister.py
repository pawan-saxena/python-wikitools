projects = {'dino': ['dinosaurs', 'Wikipedia:WikiProject Dinosaurs/Popular pages'],
	...
	'mammal': ['mammal', 'Wikipedia:WikiProject Mammals/Popular pages'],	
	'milhist': ['military history', 'Wikipedia:WikiProject Military history/Popular pages'],
	...
	'milbio': ['biography (military)', 'Wikipedia:WikiProject Biography/Military/Popular pages'],
	...
	'milmem': ['military memorials and cemeteries', 'Wikipedia:WikiProject Military history/Military memorials and cemeteries task force/Popular Pages'],
	...
	'natmil': ['national militaries', 'Wikipedia:WikiProject Military history/National militaries task force/Popular pages'],
	...
	'amcivwar': ['American Civil War', 'Wikipedia:WikiProject Military history/American Civil War task force/Popular pages'],
	...
	'mediewar': ['Medieval warfare', 'Wikipedia:WikiProject Military history/Medieval warfare task force/Popular pages'],
	'ships': ['Ships', 'Wikipedia:WikiProject Ships/Popular pages'],
	'mikej': ['Michael Jackson', 'Wikipedia:WikiProject Michael Jackson/Popular pages'],
	'physic': ['physics', 'Wikipedia:WikiProject Physics/Popular pages'],
	'acous': ['acoustics', 'Wikipedia:WikiProject Physics/Taskforces/Acoustics/Popular pages'],
	'fludyn': ['fluid dynamics', 'Wikipedia:WikiProject Physics/Taskforces/Fluid dynamics/Popular pages'],
	'relty': ['relativity', 'Wikipedia:WikiProject Physics/Taskforces/Relativity/Popular pages'],
	'christ': ['Christianity', 'Wikipedia:WikiProject Christianity/Popular pages'],
	'islam': ['Islam-related', 'Wikipedia:WikiProject Islam/Popular pages'],
	'jew': ['Judaism', 'Wikipedia:WikiProject Judaism/Popular pages'],
	'relg': ['Religion', 'Wikipedia:WikiProject Religion/Popular pages'],
	'cetac': ['cetacea', 'Wikipedia:WikiProject Cetaceans/Popular pages'],
	'primt': ['Primate', 'Wikipedia:WikiProject Primates/Popular pages'],
	'med': ['medicine', 'Wikipedia:WikiProject Medicine/Popular pages'],
	'camb': ['Cambodia', 'Wikipedia:WikiProject Cambodia/Popular pages'],
	'visart': ['visual arts', 'Wikipedia:WikiProject Visual arts/Popular pages'],
	'oregon': ['Oregon', 'Wikipedia:WikiProject Oregon/Popular pages'],
	'hindu': ['Hinduism', 'Wikipedia:WikiProject Hinduism/Popular pages'],
	'thel': ['Thelema', 'Wikipedia:WikiProject Thelema/Popular pages'],
	'id': ['Intelligent design', 'Wikipedia:WikiProject intelligent design/Popular pages'],
	'scientl': ['Scientology', 'Wikipedia:WikiProject Scientology/Popular pages'],
	'miss': ['Mississippi', 'Wikipedia:WikiProject Mississippi/Popular pages'],
	'lgbt': ['LGBT', 'Wikipedia:WikiProject LGBT studies/Popular pages'],
	'opera': ['Opera', 'Wikipedia:WikiProject Opera/Popular pages'],
	'olym': ['Olympics', 'Wikipedia:WikiProject Olympics/Popular pages'],
	'indy': ['Indiana', 'Wikipedia:WikiProject Indiana/Popular pages'],
	'numis': ['numismatic', 'Wikipedia:WikiProject Numismatics/Popular pages'],
	'croat': ['Croatia', 'Wikipedia:WikiProject Croatia/Popular pages'],
	'neuro': ['neuroscience', 'Wikipedia:WikiProject Neuroscience/Popular pages'],
	'pharm': ['pharmacology', 'Wikipedia:WikiProject Pharmacology/Popular pages'],
	'micbio': ['Microbiology', 'Wikipedia:WikiProject Microbiology/Popular pages'],
	'footb': ['football', 'Wikipedia:WikiProject Football/Popular pages'],
	'africa': ['Africa', 'Wikipedia:WikiProject Africa/Popular pages'],
	'classm': ['Classical_music', 'Wikipedia:WikiProject Classical music/Popular pages'],
	'vg': ['video game', 'Wikipedia:WikiProject Video games/Popular pages'],
	'msport': ['motorsport', 'Wikipedia:WikiProject Motorsport/Popular pages'],
	'nascar': ['NASCAR', 'Wikipedia:WikiProject NASCAR/Popular pages'],
	'hockey': ['Ice Hockey', 'Wikipedia:WikiProject Ice Hockey/Popular pages'],
	'simps': ['The Simpsons', 'Wikipedia:WikiProject The Simpsons/Popular pages'],
	'chicago': ['Chicago', 'Wikipedia:WikiProject Chicago/Popular pages'],
	'md': ['Maryland', 'Wikipedia:WikiProject Maryland/Popular pages'],
	'chem': ['Chemistry', 'Wikipedia:WikiProject Chemistry/Popular pages'],
	'math': ['mathematics', 'Wikipedia:WikiProject Mathematics/Popular pages'],
	'molbio': ['MCB', 'Wikipedia:WikiProject Molecular and Cellular Biology/Popular pages'],
}